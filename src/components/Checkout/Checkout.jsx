...
const Checkout = () => {
  ...
  return (
    <>
      <div className="checkout d-flex justify-content-center m-5">
        <div className="checkOutProducts d-flex justify-content-center flex-column align-items-center">
          <h2>Revisa tus productos</h2>
          {compra.map((items) => {
            return (
              <div
                key={items.id}
                className="productInCart d-flex container flex-column align-content-center"
              >
          ...
          <form id="form" action="" method="post" onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-center p-1 ">
              {confirm ? (
                ...
                <button
                  type="submit"
                  className=" p-1 btn btn-outline-dark m-2"
                  onClick={generatedOrder}
                >
                  Finalizar Pedido
                </button>
              )}
            ...
            <div className=" d-flex justify-content-center align-items-center">
              {orderNumber ? (
                <div className=" d-flex flex-column justify-content-center align-items-center">
                  {" "}
                  Su numero de guia es: <strong>{orderNumber}</strong> GRACIAS
                  POR SU COMPRA
                  <NavLink to="/">
                ...
                <Loader text={"Esperando confirmacion"} />
              )}
            </div>
          </div>
        </div>
